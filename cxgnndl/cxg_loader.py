...
def load_full_graph_structure(name, undirected=True):
    basedir = ""
    if name in [
            "arxiv", "products", "reddit", "papers100M", "mag240m", "wiki90m", "pubmed", "cora", "corafull", "ogbn-papers100M_1", "ogbn-papers100M_2", "ogbn-papers100M_5", "ogbn-papers100M_10", "ogbn-papers100M_25"
